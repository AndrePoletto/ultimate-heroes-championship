...
async function getHeroesInfo() {
  ...
  const firstHeroBestMatch = await compareStrings(heroInfo, state.firstHero.heroName);
  //TODO:compare the closest name
  const intelligence = heroInfo.data.results[firstHeroBestMatch].powerstats["intelligence"];
  const strength = heroInfo.data.results[firstHeroBestMatch].powerstats["strength"];
  const speed = heroInfo.data.results[firstHeroBestMatch].powerstats["speed"];
  const durability = heroInfo.data.results[firstHeroBestMatch].powerstats["durability"];
  ...
  const fullName = heroInfo.data.results[firstHeroBestMatch].biography["full-name"];
  const alignment = heroInfo.data.results[firstHeroBestMatch].biography["alignment"];

  const height = heroInfo.data.results[firstHeroBestMatch].appearance["height"][1];
  const weight = heroInfo.data.results[firstHeroBestMatch].appearance["weight"][1];
  ...
  const secondHeroBestMatch = await compareStrings(secondHeroInfo, state.secondHero.heroName);
  ...
  const secondHeroSpeed = secondHeroInfo.data.results[secondHeroBestMatch].powerstats["speed"];
  const secondHeroDurability =
    secondHeroInfo.data.results[secondHeroBestMatch].powerstats["durability"];
  const secondHeroPower = secondHeroInfo.data.results[secondHeroBestMatch].powerstats["power"];
  const secondHeroCombat = secondHeroInfo.data.results[secondHeroBestMatch].powerstats["combat"];
  ...
  const secondHeroHeight = secondHeroInfo.data.results[secondHeroBestMatch].appearance["height"][1];
  const secondHeroWeight = secondHeroInfo.data.results[secondHeroBestMatch].appearance["weight"][1];
  const secondHeroGender = secondHeroInfo.data.results[secondHeroBestMatch].appearance["gender"];
  ...
  const secondHeroImage = secondHeroInfo.data.results[secondHeroBestMatch].image;
...
function Index() {
  const firstHeroName = useSelector(
    state => state.firstHero.heroName
  );
  const secondHeroName = useSelector(
    state => state.secondHero.heroName
  );
